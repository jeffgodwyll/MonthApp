...
<em> &ltlink rel="stylesheet" media="print" href="printer.css"&gt  </em>
<br><br>
...
<div class="targetmdevices">
	<b>Targetting Screen Sizes</b>

&ltlink rel="stylesheet"
  media="handheld, only screen and (max-device-width: 320px)" href="phone.css"&gt <br>

  In the following example, phone.css would apply to devices that the browser considers "handheld" or devices with screens <= 320px wide.Prefixing a media queries with the "only" keyword will cause non CSS3-compliant browsers to ignore the rule. <br><br>
<em>
&ltlink rel="stylesheet"
  media="only screen and (min-width: 641px) and (max-width: 800px)" href="ipad.css"&gt <br> </em>
  The following would target screen sizes between 641px and 800px: <br><br>

Media queries can also appear within inline &ltstyle&gt tags. The following targets all media types when in a portrait orientation: <br>
<em>
&ltstyle&gt
...
<hr>
<div class="viewportuses">
		<br>
	
	<b>Mobile Meta Tags</b> <br>
	...
	<em>&ltmeta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=yes"&gt </em> <br><br>
	tells the browser to set the viewport to the width of the device with an initial scale of 1. This example also allows zooming, something that may be desirable for a web site but not a web app. We could prevent zooming with user-scalable=no or cap the scaling to a certain level:
	<br> <em>
	&ltmeta name=viewport
  content="width=device-width, initial-scale=1.0, minimum-scale=0.5 maximum-scale=1.0"&gt </em> <br><br>
...
<br><br><em>&ltmeta name="viewport" content="target-densitydpi=device-dpi"&gt</em>

<br><br>
	<p>Possible values for target-densitydpi are device-dpi, high-dpi, medium-dpi, low-dpi.
...
<p><em>Google is your friend. You need more, you read more.</em></p>

<p><em>Visit <a href="http://learn.shayhowe.com/html-css/building-your-first-web-page/">this site</a>" for more detailed explanations. </em></p>
